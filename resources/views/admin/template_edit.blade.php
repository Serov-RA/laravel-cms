                ...
                <div class="" role="tabpanel">
                    <ul id="form_tabs" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab_content_Template_edit"
                               id="form_tab_Template_edit"
                               role="tab"
                               data-toggle="tab"
                               aria-expanded="true"
                               class="active"
                        ...
                        <li role="presentation">
                            <a href="#tab_content_Template_edit_form_CSS"
                               id="form_tab_Template_edit_form_CSS"
                               role="tab"
                               data-toggle="tab"
                               aria-expanded="true">
                        ...
                        <li role="presentation">
                            <a href="#tab_content_Template_edit_form_JS"
                               id="form_tab_Template_edit_form_JS"
                               role="tab"
                               data-toggle="tab"
                               aria-expanded="true">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active show"
                             id="tab_content_Template_edit"
                             aria-labelledby="form_tab_Template_edit"
                             data-form="Template_edit"
                        ...
                        <div role="tabpanel"
                             class="tab-pane fade"
                             id="tab_content_Template_edit_form_CSS"
                             aria-labelledby="form_tab_Template_edit_form_CSS"
                             data-form="Template_edit_form_CSS"
                             style="margin-top: -15px">
                            <div id="w1" class="x_panel">
                                <div class="x_content">

                                    <script type="text/javascript">
                                        var cssEditForm = 'templatecss';
                                        var cssEditField = 'TemplateCss';
                                    </script>
                                    ...
                                    <ul class="list-group" id="select_css_list">
                                        @foreach ($template_css as $t_css)
                                            <li class="list-group-item text-left"
                                                ...
                                                <div class="form-group field-templatecss-{{ $t_css->css_id }}-block_pos">
                                                    <input type="hidden"
                                                           id="templatecss-{{ $t_css->css_id }}-block_pos"
                                                           class="form-control"
                                                           name="TemplateCss[{{ $t_css->css_id }}][block_pos]"
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content_Template_edit_form_JS" aria-labelledby="form_tab_Template_edit_form_JS" data-form="Template_edit_form_JS" style="margin-top: -15px">
                            <div id="w2" class="x_panel">
                                <div class="x_content">
                                    <script type="text/javascript">
                                        var jsEditForm = 'templatejs';
                                        var jsEditField = 'TemplateJs';
                                    ...
                                    <div id="js_position_{{ $pos_id }}">
                                        ...
                                        @foreach ($template_js as $t_js)
                                            ...
                                            <li class="list-group-item text-left js_item"
                                                ...
                                                <div class="form-group field-templatejs-{{ $t_js->js_id }}-block_pos">
                                                    <input type="hidden" id="templatejs-{{ $t_js->js_id }}-block_pos"
                                                           class="form-control input_block_pos"
                                                           name="TemplateJs[{{ $t_js->js_id }}][block_pos]"
                                                           value="{{ $t_js->block_pos }}">
                                                </div>
                                                <div class="form-group field-templatejs-{{ $t_js->js_id }}-view_pos">
                                                    <input type="hidden" id="templatejs-{{ $t_js->js_id }}-view_pos"
                                                           class="form-control input_view_pos"
                                                           name="TemplateJs[{{ $t_js->js_id }}][view_pos]"
                                                           value="{{ $t_js->view_pos }}">
                                                </div>
                                            </li>
                                            @endif
